...
use Hookbox\Verifiers\GitHubVerifier;
use Illuminate\Http\Request;

final class GitHubVerifierTest extends TestCase
{
    public function test_it_verifies_a_valid_github_signature_and_extracts_metadata(): void
    {
    ...
    {
        $path = dirname(__DIR__, 2).'/Fixtures/Verifiers/GitHub/'.$name;
    ...
    private function request(string $payload, array $headers): Request
    {
        ...
        return Request::create('/webhooks/github', 'POST', server: [
            ...$server,
        ], content: $payload);
    }
